<div class="pl-2 lg:w-470">
    ...
    <ul class='flex'>
        <li class="p-2 flex hover:border-b-3 border-blue-500">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 0 1-3.827-5.802" />
    ...
    <div class="mt-15">
 <div class="justify-self-end border border-gray-300  rounded-4xl mr-2">
        <input type="text" name="" placeholder="Search Here" id="" class="p-1 lg:w-full w-48">
    </div>
    <div class="">
    <div class="grid lg:grid-cols-6 grid-cols-2 lg:w-400">
        <div class="lg:w-64  w-48">
            ...
            <img src="{{asset($single_data->file_name)}}" alt="" class="w-64">
