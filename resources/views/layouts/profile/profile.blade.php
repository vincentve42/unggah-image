...
<div class="bg-gray-100 w-full h-32" style="background-image : url({{ asset('storage/banner/' . $user_data->banner) }})">
    ...
    <div class="flex lg:justify-between">
        ...
        <div>
            ...
            <div class="flex ">
                <div class="flex  ">
                <a href='/followed-saya'><p class="mr-2">{{$following_count}}</p></a> <a href='/followed-saya'><p class="text-gray-300">Following</p></a><p class="lg:ml-5 ml-3 text-gray-300"> | </p> <a href='/follower-saya'><p class="ml-2">{{ $follower_count }}</p></a><a href='/follower-saya'><p class="text-gray-300 ml-2">Follower</p></a>
            </div>
            ...
            <div class="flex ">
                ...
                <a href='/akun-saya'><p class="mr-2">{{$image_count}}</p></a> <a href='/akun-saya'><p class="text-gray-300">Image</p></a><p class="lg:ml-5 ml-3 text-gray-300"> | </p><a href='/album-saya'><p class="ml-2">{{ $album_count }}</p></a><a href='/album-saya'><p class="text-gray-300 ml-2">Album</p></a>
            </div>
