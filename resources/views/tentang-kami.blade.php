...
<div class="grid lg:grid-cols-2 grid-cols-1">
    ...
    <div class="pt-10 overflow-hidden">
        ...
        <p class="pl-10 lg:pl-5  text-xs lg:text-sm pt-5 lg:justify-self-start  lg:w-full  lg:pr-1 pr-2 hover:translate-x-1 hover:scale-105 transition duration-300">Kami adalah platform unggah gambar cepat dan gratis yang dirancang untuk memudahkan siapa saja menyimpan, membagikan, dan mengelola gambar secara online. Didirikan dengan misi memberikan layanan penyimpanan gambar yang ringan, cepat, dan andal, Kami hadir sebagai solusi ideal bagi pengguna yang membutuhkan cara sederhana untuk berbagi gambar tanpa harus membuat akun atau menghadapi proses rumit.</p>
    </div>
    <div class="lg:w-full  pr-2">
        <h1 class="pl-4 pb-2 pt-5 text-xl font-semibold lg:text-start text-center hover:scale-110 hover:translate-x-10 transition duration-500 hover:text-blue-500">Visi</h1>
        <ul>
            <li class="pl-10 lg:pl-5 lg:text-sm text-xs hover:translate-x-10 hover:scale-110 transition duration-300">Menjadi platform unggah gambar pilihan utama yang cepat, aman, dan mudah diakses siapa saja.</li>
        </ul>
    </div>
     <div class="lg:w-full w-full pr-2">
        <h1 class="pl-4 pb-2 pt-5 text-xl font-semibold lg:justify-self-start justify-self-center hover:scale-110 hover:translate-x-10 transition duration-500 hover:text-blue-500">Misi</h1>
        <ul class="">
   ...
   <div class="pt-10 pl-1 shadow-xs w-256 hidden lg:flex">
    ...
    <div>
        <div class="lg:w-full lg:pt-50  pr-2 lg:ml-60 pt-10">
        ...
        <a href="/register"><button class="ml-10 bg-blue-500 rounded-4xl lg:p-4 p-2 mt-10 mb-5 text-white lg:mt-10 hover:scale-110 transition duration-300 hover:bg-indigo-500">Join Sekarang</button></a>
        </div>
    </div>
    </div>
</div>
